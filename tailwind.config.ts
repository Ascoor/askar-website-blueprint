    ...
    extend: {
      ...
      colors: {
        ...
        sidebar: {
          ...
          foreground: '#eaf6fa',
          primary: '#36f1fe',
          'primary-foreground': '#101829',
          accent: '#0fd8c1',
          'accent-foreground': '#101829',
          border: '#141e32',
          ring: '#36f1fe',
        },
      },
      ...
      boxShadow: {
        ...
        lunar:
          '0 4px 20px -2px rgba(10, 26, 47, 0.15), 0 2px 8px -2px rgba(10, 26, 47, 0.1)',
        'lunar-lg':
          '0 8px 30px -4px rgba(10, 26, 47, 0.2), 0 4px 12px -4px rgba(10, 26, 47, 0.15)',
