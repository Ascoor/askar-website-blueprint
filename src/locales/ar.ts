export const ar = {
  ...
  heroSubtitle:
    'نحول الأعمال من خلال التكنولوجيا المتطورة وتطوير البرمجيات المخصصة',
  ...
  webDevDesc: 'مواقع ويب وتطبيقات ويب حديثة ومتجاوبة مبنية بأحدث التقنيات',
  ...
  digitalInfrastructureDesc:
    'استضافة سحابية قوية وخدمات مُدارة وحلول بنية تحتية على مستوى المؤسسات',
  aiCreativeProduction: 'الإنتاج الإبداعي بالذكاء الاصطناعي',
  aiCreativeProductionDesc:
    'إنشاء محتوى ذكي وسير عمل إبداعي آلي باستخدام أحدث تقنيات الذكاء الاصطناعي',
  virtualTours: 'جولات Matterport الافتراضية',
  virtualToursDesc:
    'جولات افتراضية ثلاثية الأبعاد غامرة وتجارب مكانية تفاعلية للأعمال',
  ...
  fortemonBrandingDesc:
    'خدمات العلامة التجارية المهنية والهوية المؤسسية وتصميم الويب المذهل',

  // Solutions Section
  solutionsTitle: 'حلولنا',
  solutionsSubtitle: 'حلول تقنية مخصصة لكل مجال',

  // Projects
  projectsTitle: 'مشاريعنا',
  projectsSubtitle: 'دراسات حالة حديثة من عملائنا',
  project1Title: 'منصة المدرسة الذكية',
  project1Desc: 'إدارة تعليمية موحدة مع تطبيقات الجوال.',
  project2Title: 'نظام إدارة العيادات',
  project2Desc: 'سجلات مرضى آمنة ومواعيد عبر الإنترنت.',
  project3Title: 'رؤى المبيعات بالذكاء الاصطناعي',
  project3Desc: 'توصيات مبنية على البيانات تعزز الإيرادات.',

  // About
  aboutTitle: 'عن شركة أسكار للحلول البرمجية',
  aboutDesc:
    'نحن شركة رائدة في تطوير البرمجيات ملتزمة بتقديم حلول مبتكرة تدفع نمو الأعمال. مع سنوات من الخبرة وفريق من المطورين المهرة، نحول الأفكار إلى منتجات رقمية قوية.',
  ...
  contactSubtitle: 'مستعد لبدء مشروعك التالي؟ اتصل بنا اليوم',
  name: 'الاسم',
  ...
  siteDescription:
    'شركة رائدة في تطوير البرمجيات تقدم حلول ويب وموبايل وسحابية متطورة. حول عملك مع خدماتنا التقنية المتخصصة.',
  ...
  ctaDesc: 'دعنا نناقش مشروعك وننشئ شيئاً رائعاً معاً.',
