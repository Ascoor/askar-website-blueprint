  ...
  const projects = isArabic ? [
    {
      ...
      description: 'تطبيق جوال متقدم للتسوق الإلكتروني مع تجربة مستخدم استثنائية',
      category: 'mobile',
  ...
  ] : [
    {
      ...
      description: 'Advanced mobile shopping application with exceptional user experience',
      category: 'mobile',
      image: portfolioMobile,
      technologies: ['React Native', 'Node.js', 'MongoDB'],
      link: '#',
    ...
    },
    {
      ...
      description: 'Advanced content management system with smart dashboard',
      category: 'web',
      image: portfolioWeb,
      technologies: ['React', 'Next.js', 'PostgreSQL'],
      link: '#',
    ...
    },
    {
      ...
      description: 'Smart platform for data analysis and predictions using AI',
      category: 'ai',
      image: portfolioAI,
      technologies: ['Python', 'TensorFlow', 'React'],
      link: '#',
    ...
    },
    {
      ...
      description: 'Professional website for tech company with responsive design',
      category: 'web',
      image: portfolioWeb,
      technologies: ['Vue.js', 'Tailwind', 'Laravel'],
      link: '#',
    ...
    },
    {
      ...
      description: 'Mobile application for fitness tracking and workout management',
      category: 'mobile',
      image: portfolioMobile,
      technologies: ['Flutter', 'Firebase', 'Dart'],
      link: '#',
    ...
    },
    {
      ...
      description: 'Advanced solution for machine learning and big data processing',
      category: 'ai',
      image: portfolioAI,
      technologies: ['Python', 'PyTorch', 'AWS'],
      link: '#',
              ...
              >
                <Card className="glass-card border-glass-border overflow-hidden group cursor-pointer hover:shadow-glow-primary transition-all duration-500">
                  ...
                  <CardContent className="p-6">
                    <h3 className={`text-xl font-bold text-foreground mb-2 ${isArabic ? 'text-right font-cairo' : 'text-left font-inter'}`}>
                      {project.title}
                    </h3>
                    
                    <p className={`text-muted-foreground mb-4 ${isArabic ? 'text-right' : 'text-left'}`}>
                      {project.description}
                    </p>
