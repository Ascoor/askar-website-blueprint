  ...
  return (
    <section className="py-20 bg-gradient-to-br from-primary to-primary-hover text-primary-foreground relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-24 -right-24 w-48 h-48 bg-foreground/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-foreground/10 rounded-full blur-3xl animate-pulse delay-1000" />
        ...
        >
          ...
          >
            <Button
              ...
              size="lg"
              variant="secondary"
              className="bg-background text-primary hover:bg-background/90 font-semibold px-8 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
            >
              {t('ctaButton')}
              {isRTL ? (
